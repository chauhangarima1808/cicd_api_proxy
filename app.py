...
__vcs_id__ = '81d450ae9cfa829fe60f51ef751db797'
__version__ = '9e7182649a98e1449f2843b8a8737c6a'
...
class Unicorn(Resource):
    def get(self):
        ...
        req = requests.get(BACKEND_API+'/unicorns')
...
api.add_resource(Unicorn, '/unicorns')
